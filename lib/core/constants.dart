...
import 'package:qarshi_kafe/core/database_helper.dart';
...
String userId = '';
String user = '';
String pwd = 'Cjiobapbaq123321';
DateTime zeroDate = DateTime(1970, 01, 01);
List<Menu> menu = [];
String _username = 'mobile';
String _password = 'Cjiobapbaq123321';
String basicAuth =
...
class CurrencyInputFormatter extends TextInputFormatter {
  ...
  static const fractionalDigits = 4;
